...
function AuditorySpectrogram = AuditorySpectrogrammodelWithCut(filename,durationCut,durationRCosDecay)
    ...
    [AuditorySpectrogram] = wav2aud(wavtemp', [frameLength timeConstant  compressionfactor octaveShift]) ;
