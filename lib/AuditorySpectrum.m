function AuditorySpectrum_ = AuditorySpectrum(wavtemp, fs_wav)
    ...
    AuditorySpectrum_ = mean(wav2aud(wavtemp', [frameLength timeConstant  compressionfactor octaveShift])) ;
